...
export const PROPERTIES = [
  {
    ...
    lat: 33.8303,
    lng: -116.5453,
    addressLine: 'North Palm Springs, CA',
    pricelabsListingId: 'PL-PS-001',
    airdnaMarketCode: 'palm-springs-ca',
    highlights: [
      {
        title: 'Pool, spa, mountain backdrop',
        body: 'A heated pool and hot tub on a resort-style deck, with a full afternoon of San Jacinto sun and a clear line to the mountains.',
        image: '/properties/palm-springs/palm-springs-23.jpg',
      },
      {
        title: 'Built for entertaining',
        body: 'Bocce court, fire-pit lounge, BBQ, putting green, and an outdoor yoga deck — plus a beautifully lit pergola dining room under the stars.',
        image: '/properties/palm-springs/palm-springs-46.jpg',
      },
      {
        title: 'Retro-chic, freshly renovated',
        body: 'Renovated midcentury bones, modernized mechanicals, and a retro-chic interior of custom wood paneling and vibrant wallpaper. Modernism Week guests notice.',
    ...
    amenities: {
      ...
      Indoor: [
        'Chef\'s kitchen',
        'Game room (pool table, karaoke, popcorn machine)',
      ...
      'Sleep & bath': [
        ...
        'Three full baths plus a half bath',
      ],
      'Tech & comfort': [
        'High-speed Wi-Fi (Spectrum gigabit)',
        'Sonos throughout',
        'Smart TVs (bring your own streaming)',
        'Climate control (concierge-managed)',
        'EV charger (Level 2)',
