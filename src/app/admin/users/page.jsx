...
export default async function UsersAdminPage() {
  ...
  if (!auth.authed) redirect('/admin/login');
          ...
          <div className="flex items-baseline justify-between">
            <div>
              ...
              <p className="mt-2 text-brand-slate">
                ...
                <span className="font-mono text-sm">/admin/*</span>. Create a new
                account for each staff member; revoke access by removing them.
              </p>
            </div>
            <Link href="/admin" className="text-sm text-brand-slate underline-offset-4 hover:underline">
              ← Back to dashboard
            </Link>
          </div>
