...
export const metadata = { title: 'Marketing · Email', robots: { index: false, follow: false } };
export const dynamic = 'force-dynamic';

export default async function EmailPage({ params }) {
  const auth = await isOwner();
  const p = params instanceof Promise ? await params : params;
  if (!auth.authed) redirect(`/admin/login?redirect=/admin/marketing/${p.property}/email`);
        ...
        <div className="mx-auto flex max-w-[88rem]">
          ...
          <div className="min-w-0 flex-1 px-5 py-10 sm:px-8 lg:px-10">
            ...
            <PhaseStub
              ...
              description="Resend-powered newsletters and drips: pre-arrival logistics, post-stay thank-you with review prompt, win-back at 6 months. Audience segmenting by past-guests / waitlist / all-subscribers. UTM-tagged links so booking attribution flows back to revenue."
