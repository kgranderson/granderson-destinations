      ...
      <main className="animate-page-in bg-brand-cloud pt-24 lg:pt-28">
        <div className="mx-auto flex max-w-[88rem]">
          ...
          <div className="min-w-0 flex-1 px-5 py-10 sm:px-8 lg:px-10">
            ...
            <PhaseStub
              phase="C"
              title="Instagram campaign engine"
              description="Define named, themed campaigns; the cadence engine drafts posts (image + caption + hashtags); you review and approve them in the queue; approved posts publish via Meta Instagram Graph API. UTM-tagged so engagement attributes back to bookings."
